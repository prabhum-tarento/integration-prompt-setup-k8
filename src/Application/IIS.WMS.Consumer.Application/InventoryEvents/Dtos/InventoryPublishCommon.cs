...
/// <summary>Shared location shape for the §3.6/3.7/3.8 publish payloads (docs/events/inventory.InventoryStateChanged.md) - a plain copy of the wire event's location, not a reference to the Infrastructure-layer type.</summary>
