...
/// <summary>Named keys for the Polly v8 pipelines registered in <see cref="ResilienceServiceCollectionExtensions"/> - resolve by key, don't hardcode the string at each call site.</summary>
