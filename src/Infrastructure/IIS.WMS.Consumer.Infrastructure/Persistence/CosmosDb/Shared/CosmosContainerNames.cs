namespace IIS.WMS.Consumer.Infrastructure.Persistence.CosmosDb.Shared;
...
public static class CosmosContainerNames
{
    ...
    public const string ItemStockInventoryExtended = "ItemStockInventoryExtended";
    ...
    public static string GetItemStockInventoryExtendedContainerName(string fulfilmentCode)
    {
        if (!Enum.TryParse<ItemStockInventorySuffix>(fulfilmentCode, ignoreCase: true, out var suffix))
        {
            throw new ArgumentException(
