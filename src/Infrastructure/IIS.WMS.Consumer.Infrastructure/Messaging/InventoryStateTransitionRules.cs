...
/// shared by <see cref="Kafka.InventoryStateChangedConsumerHostedService"/> (OrderArchive categorization)
/// and <see cref="ServiceBus.Handlers.InventoryStateChangedHandler"/> (OrderTracking relay), ported from
