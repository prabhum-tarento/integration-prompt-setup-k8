...
/// <summary>
/// Hand-written mapping from the Avro-generated <see cref="InventoryStateChanged"/> SpecificRecord
...
{
    public static InventoryStateChangedEvent ToInventoryStateChangedEvent(this InventoryStateChanged source) =>
        new(
