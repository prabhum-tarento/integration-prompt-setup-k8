...
public class MessagingServiceCollectionExtensionsTests
{
    ...
    {
        Assert.True(MessagingServiceCollectionExtensions.IsFunctionEnabled(null, MessagingServiceCollectionExtensions.InventoryEventsConsumerKey));
    }

    [Fact(DisplayName = "An empty filter allows every consumer")]
    public void IsFunctionEnabled_EmptyFilter_ReturnsTrue()
    {
        Assert.True(MessagingServiceCollectionExtensions.IsFunctionEnabled([], MessagingServiceCollectionExtensions.InventoryEventsConsumerKey));
    }

    [Fact(DisplayName = "A filter naming this consumer allows it")]
    public void IsFunctionEnabled_FilterContainsConsumer_ReturnsTrue()
    {
        var filter = new[] { MessagingServiceCollectionExtensions.InventoryStateChangedConsumerKey };

        Assert.True(MessagingServiceCollectionExtensions.IsFunctionEnabled(filter, MessagingServiceCollectionExtensions.InventoryStateChangedConsumerKey));
    }
    ...
    {
        var filter = new[] { MessagingServiceCollectionExtensions.InventoryEventsConsumerKey };

        Assert.False(MessagingServiceCollectionExtensions.IsFunctionEnabled(filter, MessagingServiceCollectionExtensions.InventoryStateChangedConsumerKey));
    }
    ...
    public void IsFunctionEnabled_FilterDifferentCase_ReturnsTrue()
    {
        ...
        Assert.True(MessagingServiceCollectionExtensions.IsFunctionEnabled(filter, MessagingServiceCollectionExtensions.InventoryEventsConsumerKey));
    }
}
