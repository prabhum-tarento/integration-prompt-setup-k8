...
- Never commit secrets, connection strings, or keys. Local development uses
  ...
  [docs/ai/cosmos-db.instructions.md](../docs/ai/cosmos-db.instructions.md) §1/§14 and
  [docs/ai/engineering-standards.instructions.md](../docs/ai/engineering-standards.instructions.md) §6).
